...
describe('AuditController', () => {
  ...
  describe('getUserLogs', () => {
    it('should return user logs', async () => {
      const mockLogs = [
        { id: '1', userId: 'user1', action: 'LOGIN', entity: 'USER', createdAt: new Date() },
        { id: '2', userId: 'user1', action: 'LOGOUT', entity: 'USER', createdAt: new Date() },
      ];
    ...
    it('should return user logs with custom limit', async () => {
      const mockLogs = [{ id: '1', userId: 'user1', action: 'LOGIN', entity: 'USER', createdAt: new Date() }];
  ...
  describe('getLogsByAction', () => {
    it('should return logs by action', async () => {
      const mockLogs = [
        { id: '1', userId: 'user1', action: 'LOGIN', entity: 'USER', createdAt: new Date() },
        { id: '2', userId: 'user2', action: 'LOGIN', entity: 'USER', createdAt: new Date() },
      ];
      ...
      expect(result).toHaveLength(2);
      expect(mockAuditService.getLogsByAction).toHaveBeenCalledWith('LOGIN', 50);
    });
  });
});
