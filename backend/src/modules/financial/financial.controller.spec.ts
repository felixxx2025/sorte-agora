...
describe('FinancialController', () => {
  ...
  describe('createDeposit', () => {
    it('should create a deposit', async () => {
      ...
      expect(mockFinancialService.createDeposit).toHaveBeenCalledWith('user1', depositDto);
    });
  });
  ...
  describe('createWithdraw', () => {
    it('should create a withdraw', async () => {
      ...
      expect(mockFinancialService.createWithdraw).toHaveBeenCalledWith('user1', withdrawDto);
    });
  });
  ...
  describe('getTransactions', () => {
    it('should return user transactions', async () => {
      ...
      expect(mockFinancialService.getTransactions).toHaveBeenCalledWith('user1');
    });
  });
});
